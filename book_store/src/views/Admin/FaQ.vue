  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Describe', value: 'describe', sortable: false },
    ...
    methods: {
      ...
      deleteItem (item) {
        ...
        if(this.dialogDelete == true){
          axios.delete(`http://localhost:5000/api/faq/${item._id}`)
        }
      },
      deleteItemConfirm () {
      ...
      save () {
        if (this.editedIndex > -1) {
          ...
          axios.put(`http://localhost:5000/api/faq/${this.editedItem._id}/${this.editedItem.name}/${this.editedItem.describe}`)
        } else {
          axios.post(`http://localhost:5000/api/faq/${this.editedItem.name}/${this.editedItem.describe}`)
