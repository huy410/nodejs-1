  ...
  export default {
    ...
    methods: {
      async LoadItens(){
        ...
        const API_URL = "http://localhost:5000/api/transportBorrow";
        // If the fetch fails,
        try {
      ...
      deleteItem (item) {
        ...
        if(this.dialogDelete == true){
          axios.delete(`http://localhost:5000/api/transportBorrow/${item._id}`)
        }
      },
      deleteItemConfirm () {
      ...
      save () {
        ...
        axios.put(`http://localhost:5000/api/transportBorrow/${this.editedItem._id}/${this.editedItem.name}/${this.editedItem.email}/${this.editedItem.address}/${this.editedItem.phoneNumber}/${this.editedItem.StartDate}/${this.editedItem.EndDate}`)
        this.close()
      },
    },
  }
